...
var Col = function (_React$PureComponent) {
  ...
  function Col() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Col.__proto__ || Object.getPrototypeOf(Col)).call.apply(_ref, [this].concat(args))), _this), _this.renderCol = function (nogutter, screenClass) {
      ...
      return _react2.default.createElement(
        ...
        function (screenClass) {
          return _react2.default.createElement(
            ...
            null,
            function (nogutter) {
              return _this.renderCol(nogutter, screenClass);
            }
          );
        }
      );
